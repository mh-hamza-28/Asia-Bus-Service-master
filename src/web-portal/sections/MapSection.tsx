    ...
    <section id="location" className="bg-white py-8 sm:py-10">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div data-reveal="left" className="card-3d grid items-stretch gap-4 md:grid-cols-[1fr_auto] md:gap-6">
          ...
          {/* Info sidebar */}
          <div data-reveal="right" className="flex flex-col justify-center gap-3 md:w-64">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-brand-deep px-4 py-2.5 text-xs font-semibold text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-brand-primary hover:shadow-lg hover:shadow-brand-deep/15"
            >
