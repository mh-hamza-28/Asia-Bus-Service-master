      ...
      <section id="home" className="relative min-h-[100dvh] overflow-hidden">
          ...
          {Array.from({ length: 10 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                background: `rgba(201, 168, 76, ${0.12 + Math.random() * 0.18})`,
              }}
            />
          ))}
        </div>
        ...
        <div className="relative flex min-h-[100dvh] flex-col px-4 pb-6 pt-28 sm:px-6 sm:pb-8 sm:pt-32 lg:hidden">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            >
              <p className="reveal-line mb-2.5 text-[9px] font-semibold uppercase tracking-[0.3em] text-brand-accent sm:text-[10px]">
              ...
              <p className="reveal-line mt-3 max-w-xs text-[12px] leading-relaxed text-white/75 sm:max-w-sm sm:text-[13px]" style={{ animationDelay: '0.6s' }}>
        ...
        <div className="relative hidden min-h-[100dvh] flex-col px-8 pb-10 pt-28 lg:flex">
          <div className="mx-auto flex w-full max-w-7xl flex-1 items-center gap-10">
            ...
            <div className="max-w-lg flex-1">
              ...
              >
                <p className="reveal-line mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-brand-accent">
                  {company.yearsInBusiness}+ Years · Lucknow's Trusted Bus Service
                </p>
                <h1 className="text-[clamp(3.5rem,5.5vw,6rem)] font-display font-extrabold leading-[0.88] tracking-tighter">
                  <span className="reveal-line text-white" style={{ animationDelay: '0.2s' }}>Travel</span><br />
                  <span className="reveal-line bg-gradient-to-r from-brand-gold via-brand-accent-light to-brand-gold bg-clip-text text-transparent" style={{ animationDelay: '0.4s' }}>
                    Luxuriously
                  </span>
                </h1>
                <div className="mt-3 h-0.5 w-20 rounded-full shimmer-gold" />
                <p className="reveal-line mt-4 max-w-md text-base leading-relaxed text-white/75" style={{ animationDelay: '0.6s' }}>
